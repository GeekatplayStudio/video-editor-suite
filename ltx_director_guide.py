...
class GAPDirectorGuide(LTXVAddGuide):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="GAPDirectorGuide",
            display_name="Geekatplay Director Guide",
            category="Geekatplay Studio/Video Editor Suite",
            description=(
                "Applies guide images from the Geekatplay Timeline Director at the frame positions "
            ...
            inputs=[
                ...
                GuideData.Input("guide_data", tooltip="Guide data produced by Geekatplay Timeline Director."),
