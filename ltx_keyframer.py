...
class GAPKeyframer(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        inputs = [
            ...
            io.Image.Input("multi_input", tooltip="Batched images from GAPMultiImageLoader"),
        ]
        ...
        return io.Schema(
            node_id="GAPKeyframer",
            display_name="Geekatplay Keyframer",
